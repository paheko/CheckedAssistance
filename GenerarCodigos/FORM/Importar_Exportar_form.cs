...
namespace punto_venta
{
    public partial class Importar_Exportar_form : Form
    {
        ...
        {
           /* List<DTOAlumnos> productos = new List<DTOAlumnos>();
        ...
        public bool CatecismoRepetido(string NombreCatecismo) 
        {
            bool repetido = false;
            List<DTOCatecismo> catecismos = new List<DTOCatecismo>();
            catecismos = new DAOCatecismo().GetCatecismo();
            foreach(DTOCatecismo cate in catecismos)
            {
                if(cate.catecismo.Equals(NombreCatecismo))
                {
                    repetido = true;
                    break;
                }
        ...
        public bool Repetido(string codigo,  List<DTOAlumnos> lista) 
        {           
            bool repetido=false;
            foreach(DTOAlumnos temp in lista)
            {
